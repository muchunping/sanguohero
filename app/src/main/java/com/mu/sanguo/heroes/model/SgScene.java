 ...
 */
public abstract class SgScene implements Scene, XmlCreator {
    ...
    public static Scene createByXml(XmlResourceParser xrp) throws IOException, XmlPullParserException {
        SgScene scene;
        ...
        switch (type) {
            ...
            case TYPE_ISOLATION:
                ...
                break;
            default:
                throw new XmlPullParserException("invalid type:" + type);

        }
        scene.parseFromXml(xrp);
        return scene;
    }
